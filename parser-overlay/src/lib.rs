...
fn class_string_to_color(class_name: &str) -> egui::Color32 {
    ...
    match class_name {
        // "Magma Miner"  => egui::Color32::from_rgb(217, 30, 24),
        "Magma Miner"  => egui::Color32::from_rgb(196, 75, 0),
        // "Mosscloak"    => egui::Color32::from_rgb(38, 194, 129),
        "Mosscloak"    => egui::Color32::from_rgb(0, 130, 13),
        // "Clairvoyant"  => egui::Color32::from_rgb(1, 1, 122),
        "Clairvoyant"  => egui::Color32::from_rgb(130, 0, 0),
        // "Weaver"       => egui::Color32::from_rgb(150, 54, 148),
        "Weaver"       => egui::Color32::from_rgb(173, 148, 0),
        // "Obelisk"      => egui::Color32::from_rgb(103, 128, 159),
